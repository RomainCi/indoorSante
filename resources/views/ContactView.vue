<template>
  <main>
    ...
    <div class="containerBack">
      ...
      <h2 class="courrier">Nous envoyer du courrier</h2>
      <p>10 rue du Bain Aux Plantes 67000 Strasbourg </p>
    </div>
  </main>
...
@font-face {
  ...
  font-weight: 400;
  src: url("/resources/assets/fonts/AmaticSC-Regular.ttf") format('truetype');
}
